...
//fun main() {
//    var names = arrayOf("Adhit", "budi")
//
//    println(names[0] + " sedang bermain bersama " + names[1] )
//}

fun main() {
    val names = arrayOf("Adhit" , "budi")
    println("${names[0]} sedang bermain bersama ${names[1]}") //${func}
}